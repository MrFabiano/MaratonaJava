...
import programer.estruturadados.linkedlist.Celula;
...
//            this.total = this.total + 1;
    ...
    //Metodo que adiciona elemento no meio da lista de acordo com a posição
    public void adiciona(int posicao, Object elemento){
        if(posicao == 0){
            ...
            Celula nova = new Celula(elemento, anterior.getProximo());  //novo
            anterior.setProximo(nova);
            proxima.setAnterior(anterior); //novo
